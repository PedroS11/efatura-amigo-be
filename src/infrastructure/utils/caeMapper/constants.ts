...
export const EXACT_CAE_REV3_MAP: Record<string, Categories> = {
  ...
  "91020": Categories["Atividades dos museus e monumentos historicos"], // Atividades de museus e coleções
  "91030": Categories["Atividades dos museus e monumentos historicos"], // Atividades dos sítios e monumentos históricos
  // Outros
